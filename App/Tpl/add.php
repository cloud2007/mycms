<div id="add">
	...
	<form method="post" action="" name="addform" id="addform">
		<ul>
			<li><div><em>*</em>姓名:</div><input type="text" name="uname" datatype="*" nullmsg="学生姓名不能为空" errormsg="学生姓名" /></li>
			...
			<li><div>性别:</div><input type="radio" name="sex" value="1"> 男　<input type="radio" name="sex" value="2"> 女</li>
