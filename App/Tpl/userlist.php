<div id="main">
	<table border="0" cellpadding="0" cellspacing="0" class="mtable1">
		...
		<tr class="table_main">
			...
			<td><a class="st1" href="/login/modify/<?php echo $v->id;?>">编辑</a> | <?php if($v->is_zz==1){?><a class="st2" href="/users/ajax_zuzhang_c/<?php echo $v->id;?>">取消组长</a><?php }else{?><a class="st2" href="/users/ajax_zuzhang/<?php echo $v->id;?>">设为组长</a><?php }?> | <a class="st1 inline" href="/users/ajax_group/<?php echo $v->id;?>">移动分组</a> | <a class="st1" href="/users/ajax_setpwd/<?php echo $v->id;?>">重设密码</a></td>
		</tr>
		<?php }?>
		<tr class="table_con">
