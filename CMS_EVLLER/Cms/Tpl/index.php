...
<div class="head">
	<div class="top">
		...
		<div class="top_link">
			<ul>
				<li class="welcome">您好：<?php echo $UserInfo->userID;?>，欢迎使用EvllerCMS！</li>
	...
	<div class="topnav">
		...
		<div class="scroll"><a href='http://www.evller.com' target='_blank'>官方网站</a> </div>
	</div>
</div>
<div class="left">
