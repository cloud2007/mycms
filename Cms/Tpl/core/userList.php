...
<div id="manager">
	...
	<p>管理导航：<a href="/admin.php/Core/userList">用户管理</a>&nbsp;|&nbsp;<a href="/admin.php/Core/addUser">添加用户</a></p>
</div>
...
<table width="100%" class="content_table">
	...
	<tr class="content">
		...
		<td><a href="/admin.php/Core/userEdit/?id=<?php echo $v->id;?>">修改</a>|<a href="javascript:if (confirm('确定要删除此条信息吗？')) {location='/admin.php/Core/userDelete/<?php echo $v->id;?>';}">删除</a> </td>
	</tr>
	<?php }?>
</table>
