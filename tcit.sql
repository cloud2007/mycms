...
(11, 1, '网站配置', '配置管理', 1, 'News', '', 'add', 'news', 1, 'noadd|nodel|title|title1|title2|title3|creatTime', '所属类别', '标题名称', 'Title', 'Keywords', 'Descriptio', '', '', '', '', '', '', '', '', '', '', '', '', '详细内容', '', '', '', '', '', '上传图片', '上传大图', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '浏览次数', '类别名称', '', '', '', '', '', '', '', '', '', '', '姓名', '公司名称', '手机号', '电话号码', '传真号码', '附加图片', '电子邮件', '邮编', '地址', '', '', '', '', '', '', '', '', '', '', '创建时间'),
(12, 2, '网站配置', '幻灯添加', 2, 'News/add', 'News', 'add', 'news', 1, 'title|smallpic|name4|hits|creatTime', '所属类别', '标题名称', '', '', '', '', '', '', '', '', '', '', '', '', '', '链接地址', '', '详细内容', '', '', '', '', '', '上传图片', '上传大图', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '排序(数字)', '类别名称', '', '', '', '', '', '', '', '', '', '', '姓名', '公司名称', '手机号', '电话号码', '传真号码', '附加图片', '电子邮件', '邮编', '地址', '', '', '', '', '', '', '', '', '', '', '创建时间'),
(13, 3, '网站配置', '友链添加', 3, 'News/add', 'News', 'add', 'news', 1, 'title|name4|hits|creatTime', '所属类别', '标题名称', '', '', '', '', '', '', '', '', '', '', '', '', '', '链接地址', '', '详细内容', '', '', '', '', '', '上传图片', '上传大图', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '排序(数字)', '类别名称', '', '', '', '', '', '', '', '', '', '', '姓名', '公司名称', '手机号', '电话号码', '传真号码', '附加图片', '电子邮件', '邮编', '地址', '', '', '', '', '', '', '', '', '', '', '创建时间');
